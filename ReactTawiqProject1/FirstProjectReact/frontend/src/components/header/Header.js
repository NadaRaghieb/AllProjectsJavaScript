...
import './Header.css';
import { Navbar, Button, Nav, NavDropdown,  Container, Offcanvas, Image  } from 'react-bootstrap';
      ...
      <Offcanvas.Body id="body">
        ...
        <Link to="/main">
          <Button id="home" variant="" style={{ width: '19rem',textAlign: "left", border: 'black 2px', borderRadius: '7px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} 
           size="lg"> <Image src={home1} style={{ width: "33px", marginTop: "10px", marginRight: "19px" ,marginLeft: "5px", marginBottom: "10px"}} alt=''/> Home </Button></Link>{' '} <br></br> <br></br>


		  <Link to="/permits">
      <Button id="home" variant=""style={{ width: '19rem',textAlign: "left", border: 'black 2px', borderRadius: '7px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} 
       size="lg"> <Image src={permits} style={{ width: "45px", marginTop: "10px", marginRight: "9px" ,marginLeft: "1px", marginBottom: "10px"}}alt='' /> Permits</Button></Link>{' '} <br></br> <br></br>
       
                 <Link to="/cardDash">
                <Button  id="home" variant=""style={{ width: '19rem',textAlign: "left", border: 'black 2px', borderRadius: '7px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} 
           size="lg"> <Image src={dash1} style={{ width: "27px", marginTop: "10px", marginRight: "20px" ,marginLeft: "8px", marginBottom: "10px"}} alt=''/> Dashboard</Button></Link>{' '} <br></br> <br></br>

<Link to="/notifacations">
		  <Button id="home" variant=""style={{ width: '19rem',textAlign: "left", border: 'black 2px', borderRadius: '7px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} 
      size="lg"> <Image src={noti} style={{ width: "28px", marginTop: "10px", marginRight: "20px" ,marginLeft: "7px", marginBottom: "10px"}} alt=''/> Notifications</Button></Link>{' '} <br></br> <br></br>

<Link to="/organ">
		  <Button id="home" variant=""style={{ width: '19rem',textAlign: "left", border: 'black 2px', borderRadius: '7px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} 
       size="lg"> <Image src={organ} style={{ width: "46px", marginTop: "10px", marginRight: "10px" ,marginLeft: "1px", marginBottom: "10px"}} alt=''/> Organ Donation</Button></Link>{' '} <br></br> <br></br>


		  <Button id="home" variant=""style={{ width: '19rem',textAlign: "left", border: 'black 2px', borderRadius: '7px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }} 
       size="lg"> <Image src={report} style={{ width: "30px", marginTop: "10px", marginRight: "20px" ,marginLeft: "11px", marginBottom: "10px"}} alt=''/> Reports</Button>{' '} <br></br>
